    ...
    for(let i = 1; i <= users.length; i++) {
        ...
        document.write(users[i].title + "<br>")
        document.write(users[i].department + "<br>")
        document.write(users[i].firstName + "<br>")
        document.write(users[i].lastName + "<br>")
        document.write(users[i].address.city + "<br>")
        document.write(users[i].age + "<br>")
        document.write("<br>")
    }
